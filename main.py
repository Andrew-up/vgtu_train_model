...
from definitions import MODEL_H5_PATH, ANNOTATION_FILE_PATH, MODEL_H5_FILE_NAME, ANNOTATION_FILE_PATH_TEST, ANNOTATION_FILE_PATH_TRAIN, ANNOTATION_FILE_PATH_VALID
